...
public class AttendanceController {
    ...
    @PostMapping
    public ResponseEntity<Attendance> createAttendance(Principal principal, @RequestBody Attendance attendance) {
        return ResponseEntity.ok(service.create(attendance, principal));
    }
